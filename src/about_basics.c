...
/**
 * You need to change the values s.t. they match
...
/**
* Replace TODO to the actual value in decimal?
*/
Test(about_basics, variables)
{
    ...
    */
    ...
    // I'm not sure about this... bc it's gt? so greater than...
    unsigned int ui = 3735928560;
    /*
    ...
    */
    ...
    // You will also have to change the value to some of these so that they match
